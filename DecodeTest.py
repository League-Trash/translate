...
#     # corpus_file = maybe_download(directory, "Nern.txt",
#     #                              _WMT_ENFR_TRAIN_URL)
#
#     corpus_file = "./Data/Nern.txt"
#     # print("Extracting tar file %s" % corpus_file)
#     print("Using corpus file %s" %corpus_file)
...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  train_path = "./Data/Nern.txt"
  # dev_path = get_wmt_enfr_dev_set(data_dir)
  dev_path = "./Data/NernTest.txt"
...
def prepare_data(data_dir, from_train_path, to_train_path, from_dev_path,
                 to_dev_path, from_vocabulary_size,
  ...
  to_vocab_path = './Data/NernVocab.txt'
  from_vocab_path = './Data/NernVocab.txt'
  ...
  print(from_train_ids_path, to_train_ids_path,
...
prepare_data('./Data','./Data/Nern.txt','./Data/Nern.txt','./Data/NernTest.txt','./Data/NernTest.txt',40000,40000);